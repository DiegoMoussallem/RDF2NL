 ...
 */
public class LiteralConverterSpanish {

	// private static final Locale ENGLISH_LOCAL = Locale.UK;
	private static final Locale PORTUGUESE_LOCAL = new Locale("pt", "BR");
	private static final Logger logger = LoggerFactory.getLogger(LiteralConverterSpanish.class);
	...
	public LiteralConverterSpanish(IRIConverter iriConverter) {
	...
	public static void main(String[] args) {
		LiteralConverterSpanish conv = new LiteralConverterSpanish(
				new DefaultIRIConverterSpanish(SparqlEndpoint.getEndpointDBpediaLiveAKSW()));
