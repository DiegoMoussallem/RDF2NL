package org.aksw.rdf2en.triple2nl.util;
...
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/ontology/thumbnail' ) )"
				...
				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/property/wikiPageUsesTemplate' ) )"
...
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/property/nome' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/ontology/mission' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://wikidata.dbpedia.org/property/' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/property/imagem' ) )"
////				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/ontology/nationality' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/property/tipo' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/ontology/type' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/property/legenda' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/property/foto' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/property/imagesize' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/property/premio' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/property/tamanho' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/property/patente' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/ontology/occupation' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/property/topo' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/property/idioma' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/ontology/picture' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/property/site' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/property/aposentadoria' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/property/website' ) )"
	...
	public boolean hasDeathPlace(String uri) {
		...
		String sparqlQuery = " PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>"
		 ...
		 + "SELECT DISTINCT ?o WHERE {<" + uri + "> ?p ?o."
		 		+ "FILTER (?p = <http://dbpedia.org/ontology/deathPlace> || ?p = <http://dbpedia.org/property/localMorte> )}";
