package org.aksw.rdf2es.triple2nl.util;
...
public class Sparql {
	...
	public Set<Triple> getTriples(String resource) {
		...
		String ontology_service = "http://es.dbpedia.org/sparql";
...
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/ontology/thumbnail' ) )"
				...
				+ "FILTER ( !strstarts(str(?p), 'http://es.dbpedia.org/property/wikiPageUsesTemplate' ) )"
...
//				+ "FILTER ( !strstarts(str(?p), 'http://es.dbpedia.org/property/nome' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/ontology/mission' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://wikidata.dbpedia.org/property/' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://es.dbpedia.org/property/imagem' ) )"
////				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/ontology/nationality' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://es.dbpedia.org/property/tipo' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/ontology/type' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://es.dbpedia.org/property/legenda' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://es.dbpedia.org/property/foto' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://es.dbpedia.org/property/imagesize' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://es.dbpedia.org/property/premio' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://es.dbpedia.org/property/tamanho' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://es.dbpedia.org/property/patente' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/ontology/occupation' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://es.dbpedia.org/property/topo' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://es.dbpedia.org/property/idioma' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://dbpedia.org/ontology/picture' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://es.dbpedia.org/property/site' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://es.dbpedia.org/property/aposentadoria' ) )"
//				+ "FILTER ( !strstarts(str(?p), 'http://es.dbpedia.org/property/website' ) )"
	...
	public boolean hasDeathPlace(String uri) {
		...
		String sparqlQuery = " PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>"
		 ...
		 + "SELECT DISTINCT ?o WHERE {<" + uri + "> ?p ?o."
		 		+ "FILTER (?p = <http://dbpedia.org/ontology/deathPlace> || ?p = <http://es.dbpedia.org/property/localMorte> )}";
