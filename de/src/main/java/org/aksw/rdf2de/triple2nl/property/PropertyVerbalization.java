...
public class PropertyVerbalization {
	...
	public PropertyVerbalization(String propertyURI, String propertyText, String posTags,
	...
	/**
	 * @param verbalizationType
	 *            the verbalizationType to set
	 */
	 ...
	 *            the expanded verbalization text
	 */
