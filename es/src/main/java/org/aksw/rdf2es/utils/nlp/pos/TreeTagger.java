package org.aksw.rdf2es.utils.nlp.pos;
...
public class TreeTagger implements PartOfSpeechTagger {
	...
	public TreeTagger(String language) throws IOException {
//		System.setProperty("treetagger.home","/Users/diegomoussallem/Documents/workspace/sw2pt/src/main/resources/models/pt/TreeTagger/");
		...
		tt.setModel("spanish-ancora-par-linux-3.2-utf8.bin");
	}
	...
	public List<String> tagTopK(String sentence) {
	  ...
	  public static void main(String[] args) throws Exception {
	    ...
	    // in the "bin" subdirectory - in this example at "/opt/treetagger/bin/tree-tagger"
		  ...
		  String language = "pt";
		  TreeTagger tt = new TreeTagger(language);
		  String tags = tt.tag("el lugar de nacimiento del Albert Einstein es Ulm.");
		  //String tags = tt.tag("equivalencia");
		  System.out.println(tags);
		  
		  boolean saber = StringUtils.isNumeric("123");
		  System.out.println(saber);
		  
		  String lemmas = tt.getLemma("armarios");
