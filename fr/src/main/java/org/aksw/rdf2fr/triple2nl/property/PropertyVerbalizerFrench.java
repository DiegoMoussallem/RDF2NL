package org.aksw.rdf2fr.triple2nl.property;
///*
// * #%L
// * Triple2NL
// * %%
...
import org.aksw.rdf2fr.triple2nl.converter.DefaultIRIConverter;
...
import org.aksw.rdf2fr.triple2nl.nlp.StanfordCoreNLPWrapper;
import org.aksw.rdf2fr.triple2nl.util.Preposition;
import org.aksw.rdf2fr.utils.nlp.pos.TreeTagger;
import org.apache.jena.atlas.logging.Log;
import org.apache.log4j.Logger;
import simplenlg.features.Tense;

import static org.aksw.rdf2fr.triple2nl.util.PennTreebankTagSet.*;
 ...
 *
 */
public class PropertyVerbalizerFrench {
	
    private static final Logger logger = Logger.getLogger(PropertyVerbalizerFrench.class);
	...
	public PropertyVerbalizerFrench(QueryExecutionFactory qef, String cacheDirectory, Dictionary wordnetDictionary) {
		this(new DefaultIRIConverterFrench(qef, cacheDirectory), wordnetDictionary);
	}
	
    public PropertyVerbalizerFrench(IRIConverter uriConverter, Dictionary wordnetDictionary) {
...
//    			logger.info("...using Treetagger analysis...");
//    			PropertyVerbalizationType verbalizationType = getTypeByLinguisticAnalysisTreeTagger(propertyText);
...
//			tree.pennPrint();
	...
	private PropertyVerbalizationType getTypeByLinguisticAnalysisTreeTagger(String propertyText) {
		...
		System.out.println("PropertyText: " + propertyText);
	        if (propertyText.contains(" ")) {
	            ...
	            double score = getScore(propertyText);
    ...
    public static void main(String args[]) throws Exception{
        PropertyVerbalizerFrench pp = new PropertyVerbalizerFrench(new QueryExecutionFactoryHttp("http://fr.dbpedia.org/sparql"), "cache", null);
