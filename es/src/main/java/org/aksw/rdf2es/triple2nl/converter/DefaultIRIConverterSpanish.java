 ...
 * #L%
 */
package org.aksw.rdf2es.triple2nl.converter;
...
import org.aksw.rdf2es.triple2nl.converter.URIDereferencer.DereferencingFailedException;
 ...
 *
 */
public class DefaultIRIConverterSpanish implements IRIConverter {

	private static final Logger logger = LoggerFactory.getLogger(DefaultIRIConverterSpanish.class);
	...
	public DefaultIRIConverterSpanish(SparqlEndpoint endpoint, String cacheDirectory) {
		this(new QueryExecutionFactoryHttp(endpoint.getURL().toString(), endpoint.getDefaultGraphURIs()),
				cacheDirectory);
	}

	public DefaultIRIConverterSpanish(SparqlEndpoint endpoint) {
		this(endpoint, null);
	}

	public DefaultIRIConverterSpanish(QueryExecutionFactory qef) {
		this(qef, null);
	}

	public DefaultIRIConverterSpanish(QueryExecutionFactory qef, String cacheDirectory) {
		this.qef = qef;
	...
	public DefaultIRIConverterSpanish(Model model) {
		this(new QueryExecutionFactoryModel(model));
	}

	public DefaultIRIConverterSpanish(OWLOntology ontology) {
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		DefaultIRIConverterSpanish converter = new DefaultIRIConverterSpanish(
