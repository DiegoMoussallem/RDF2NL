...
// import org.aksw.rdf2pt.triple2nl.converter.DefaultIRIConverterGerman;
// import org.aksw.rdf2pt.triple2nl.converter.IRIConverter;
// import org.aksw.rdf2pt.triple2nl.converter.LiteralConverterGerman;
...
// import org.aksw.rdf2pt.triple2nl.nlp.relation.BoaPatternSelector;
// import org.aksw.rdf2pt.triple2nl.nlp.stemming.PlingStemmer;
// import org.aksw.rdf2pt.triple2nl.property.PropertyVerbalization;
// import org.aksw.rdf2pt.triple2nl.property.PropertyVerbalizationType;
// import org.aksw.rdf2pt.triple2nl.property.PropertyVerbalizerGerman;
// import org.aksw.rdf2pt.triple2nl.util.GenericType;
...
// *
// */
// public class TripleConverterGerman {
//
// private static final Logger logger =
// LoggerFactory.getLogger(TripleConverterGerman.class);
//
// private static String DEFAULT_CACHE_BASE_DIR =
// System.getProperty("java.io.tmpdir");
// private static String DEFAULT_CACHE_DIR = DEFAULT_CACHE_BASE_DIR +
// "/triple2nl-cache/german";
//
// private NLGFactory nlgFactory;
// private Realiser realiser;
//
// private IRIConverter uriConverter;
// private LiteralConverterGerman LiteralConverterGerman;
// private PropertyVerbalizerGerman pp;
...
//
// public TripleConverterGerman() {
// this(new QueryExecutionFactoryModel(ModelFactory.createDefaultModel()),
// DEFAULT_CACHE_DIR, Lexicon.getDefaultLexicon());
// }
//
// public TripleConverterGerman(SparqlEndpoint endpoint) {
// this(endpoint, DEFAULT_CACHE_DIR);
// }
//
// public TripleConverterGerman(QueryExecutionFactory qef, String
// cacheDirectory, Dictionary wordnetDirectory) {
// this(qef, null, null, cacheDirectory, wordnetDirectory, null);
// }
//
// public TripleConverterGerman(SparqlEndpoint endpoint, String cacheDirectory)
// {
...
//
// public TripleConverterGerman(SparqlEndpoint endpoint, String cacheDirectory,
// Dictionary wordnetDirectory, Lexicon lexicon) {
// this(new QueryExecutionFactoryHttp(endpoint.getURL().toString(),
// endpoint.getDefaultGraphURIs()), null,
// null, cacheDirectory, wordnetDirectory, lexicon);
// }
//
// public TripleConverterGerman(QueryExecutionFactory qef, IRIConverter
// uriConverter, String cacheDirectory, Dictionary wordnetDirectory) {
// this(qef, null, uriConverter, cacheDirectory, wordnetDirectory,
...
// }
//
// public TripleConverterGerman(QueryExecutionFactory qef,
// PropertyVerbalizerGerman PropertyVerbalizerGerman, IRIConverter uriConverter,
// String cacheDirectory, Dictionary wordnetDirectory, Lexicon lexicon) {
// if(uriConverter == null){
// uriConverter = new DefaultIRIConverterGerman(qef, cacheDirectory);
// }
// this.uriConverter = uriConverter;
//
// if(PropertyVerbalizerGerman == null){
// PropertyVerbalizerGerman = new PropertyVerbalizerGerman(uriConverter,
// wordnetDirectory);
// }
// pp = PropertyVerbalizerGerman;
//
// if(lexicon == null) {
//
// lexicon = new DBLexicon ( new XMLAccessor (
// "src/main/resources/german-lexicon.xml" ) ) ;
//
...
//
// LiteralConverterGerman = new LiteralConverterGerman(uriConverter);
// LiteralConverterGerman.setEncapsulateStringLiterals(encapsulateStringLiterals);
//
...
// CoordinatedPhraseElement typesConjunction =
// nlgFactory.createCoordinatedPhrase();
//
// // separate type triples from others
// List<Triple> typeTriples = triples.stream().filter(t ->
// t.predicateMatches(RDF.type.asNode())).collect(Collectors.toList());
...
// CoordinatedPhraseElement combinedObject =
// nlgFactory.createCoordinatedPhrase();
//
...
// // combine all objects in a coordinated phrase
// CoordinatedPhraseElement combinedLastTwoObjects =
// nlgFactory.createCoordinatedPhrase(phrase1.getObject(), phrase2.getObject());
...
// CoordinatedPhraseElement othersConjunction =
// nlgFactory.createCoordinatedPhrase();
...
// * @param t the triple
// * @param negated if phrase is negated
// * @param reverse whether subject and object should be changed during
// verbalization
// * @return the phrase
// */
// public SPhraseSpec convertToPhrase(Triple t, boolean negated, boolean
// reverse) {
...
//
// /*-
// * if the predicate is a noun we generate a possessive form, i.e. 'SUBJECT'S
// PREDICATE be OBJECT'
// */
...
// NPPhraseSpec predicateNounPhrase =
// nlgFactory.createNounPhrase(PlingStemmer.stem(predicateAsString));
...
// String language =
// Locale.forLanguageTag(languageTag).getDisplayLanguage(Locale.ROOT);
...
// //simple heuristic: OBJECT is variable and predicate is of type
...
// p.setSubject(subjectElement);
// p.setVerbPhrase(nlgFactory.createVerbPhrase("be " + predicateAsString + "
// of"));
// p.setObject(objectElement);
// }
...
// else {
//
// List<org.aksw.rdf2pt.triple2nl.nlp.relation.Pattern> l = BoaPatternSelector
...
// }
// p.setVerb(BoaPatternSelector.getNaturalLanguageRepresentation(predicate.toString(),
// 1)
...
// * {@see LiteralConverterGerman#setEncapsulateStringLiterals(boolean)}
// * @param encapsulateStringLiterals TRUE if string has to be wrapped in "",
// otherwise FALSE
// */
// public void setEncapsulateStringLiterals(boolean encapsulateStringLiterals) {
// this.LiteralConverterGerman.setEncapsulateStringLiterals(encapsulateStringLiterals);
// }
//
// /**
...
// || reasoner.getRange(
// new
// OWLDataPropertyImpl(IRI.create(triple.getPredicate().getURI()))).asOWLDatatype().getIRI().equals(OWL2Datatype.XSD_BOOLEAN.getIRI()));
// }
//
// /**
// * @param returnAsSentence whether the style of the returned result is a
// proper English sentence or just a phrase
// */
...
//
// /**
// * @param useGenderInformation whether to use the gender information about a
// resource
// */
...
// object = nlgFactory.createNounPhrase(nlgFactory.createWord(label,
// LexicalCategory.NOUN));
// } else {
// object = nlgFactory.createNounPhrase(GenericType.ENTITY.getNlr());
// }
...
// return nlgFactory.createNounPhrase(nlgFactory.createWord(varNode.toString(),
// LexicalCategory.NOUN));
// }
//
...
// // convert the literal
// String literalText = LiteralConverterGerman.convert(lit);
// NPPhraseSpec np =
// nlgFactory.createNounPhrase(nlgFactory.createWord(literalText,
// LexicalCategory.NOUN));
// np.setPlural(LiteralConverterGerman.isPlural(lit));
// return np;
// }
//
...
//// System.out.println(new TripleConverterGerman().convert(
//// Triple.create(
...
//
// lexicon = new DBLexicon ( new XMLAccessor (
// "/Users/diegomoussallem/Documents/workspace/RDF2PT/src/main/resources/german-lexicon.xml"
// ));
// //lexicon.loadData();
...
// DocumentElement s1 = factory.createSentence(frau , " sehen " , mann ) ;
// System.out.println (realiser.realise ( s1 ) ) ;
// }
// }
