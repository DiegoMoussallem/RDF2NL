package org.aksw.rdf2nl.utils.nlp.lemma;

// package org.aksw.sw2pt.utils.nlp.lemma;
//
...
// * That is, it only does noun plurals, pronoun case, and verb endings, and not
// things like comparative adjectives or
// * derived nominals. It is based on a finite-state transducer implemented by
// John Carroll et al., written in flex
// * and publicly available. See:
