...
//
// import org.aksw.sw2pt.utils.nlp.token.ApacheTokenizer;
// import org.aksw.sw2pt.utils.nlp.token.Tokenizer;
//
...
// "models/en/opennlp/en-pos-maxent.bin";
//
...
//
// InputStream modelIn =
// this.getClass().getClassLoader().getResourceAsStream(MODEL_PATH);
// POSModel model = null;
// try {
...
// taggedSentences.add(convert2TaggedSentence(tokens,
// (String[])s.getOutcomes().toArray(new String[s.getOutcomes().size()])));
// }
