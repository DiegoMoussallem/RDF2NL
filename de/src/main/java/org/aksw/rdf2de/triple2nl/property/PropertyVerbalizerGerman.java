package org.aksw.rdf2de.triple2nl.property;
...
// import org.aksw.rdf2pt.triple2nl.nlp.StanfordCoreNLPWrapper;
...
//
// import static org.aksw.rdf2pt.triple2nl.util.PennTreebankTagSet.*;
//
/// **
...
// *
// */
// public class PropertyVerbalizerGerman {
//
// private static final Logger logger =
// Logger.getLogger(PropertyVerbalizerGerman.class);
//
// private double threshold = 2.0;
// private Preposition preposition;
// private Dictionary database;
//
// private final String VERB_PATTERN = "^((VP)|(have NP)|(be NP P)|(be VP P)|(VP
// NP)).*";
// private StanfordCoreNLPWrapper pipeline;
// private boolean useLinguisticalAnalysis = true;
//
// private final List<String> auxiliaryVerbs = Lists.newArrayList("do", "have",
// "be", "shall", "can", "may");
//
// private IRIConverter uriConverter;
//
// public PropertyVerbalizerGerman(QueryExecutionFactory qef, String
// cacheDirectory, Dictionary wordnetDictionary) {
// this(new DefaultIRIConverterGerman(qef, cacheDirectory), wordnetDictionary);
// }
//
// public PropertyVerbalizerGerman(IRIConverter uriConverter, Dictionary
// wordnetDictionary) {
// this.uriConverter = uriConverter;
// try {
// this.database = wordnetDictionary == null ?
// Dictionary.getDefaultResourceInstance() : wordnetDictionary;
...
// if(propertyVerbalization.getVerbalizationType() ==
// PropertyVerbalizationType.UNSPECIFIED || propertyText.split(" ").length == 1)
// {
...
//
// for (Word word : words) {//System.out.println(s[j] + ":" +
// synsets[i].getTagCount(s[j]));
...
// iw = database.lookupIndexWord(POS.VERB, token); // does morphological
// processing, otherwise use getIndexWord
// if(iw != null) {
// synsets = iw.getSenses();
// for (Synset synset : synsets) {
// List<Word> words = synset.getWords();
...
// PropertyVerbalizationType.UNSPECIFIED;
...
// if(tree.value().matches(Joiner.on('|').join(Lists.newArrayList(S, SBAR,
// SBARQ, SINV, FRAGMENT)))){
...
// pattern = split[0] + " DET " + Joiner.on(" ").join(Arrays.copyOfRange(split,
// 1, split.length));
// }
// }
...
// verbalizationType = PropertyVerbalizationType.VERB;
// }
// return new PropertyVerbalization(propertyURI, propertyText, pattern,
// verbalizationType);
// }
//
...
// }
//
// private void computeExpandedVerbalization(PropertyVerbalization
...
// expandedForm = "is" + " a " + Joiner.on("
// ").join(Arrays.copyOfRange(text.split(" "), 1, split.length));
// }
//
...
// PropertyVerbalizerGerman pp = new PropertyVerbalizerGerman(new
// QueryExecutionFactoryHttp("http://dbpedia.org/sparql"), "cache", null);
//
