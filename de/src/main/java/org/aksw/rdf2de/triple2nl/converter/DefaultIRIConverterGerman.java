package org.aksw.rdf2de.triple2nl.converter;
...
// import
/// org.aksw.rdf2pt.triple2nl.converter.URIDereferencer.DereferencingFailedException;
...
// *
// */
// public class DefaultIRIConverterGerman implements IRIConverter{
//
// private static final Logger logger =
/// LoggerFactory.getLogger(DefaultIRIConverterGerman.class);
//
...
//
// public DefaultIRIConverterGerman(SparqlEndpoint endpoint, String
/// cacheDirectory) {
// this(new QueryExecutionFactoryHttp(endpoint.getURL().toString(),
/// endpoint.getDefaultGraphURIs()), cacheDirectory);
// }
//
// public DefaultIRIConverterGerman(SparqlEndpoint endpoint) {
// this(endpoint, null);
// }
//
// public DefaultIRIConverterGerman(QueryExecutionFactory qef) {
// this(qef, null);
// }
//
// public DefaultIRIConverterGerman(QueryExecutionFactory qef, String
/// cacheDirectory) {
// this.qef = qef;
//
...
// }
// logger.debug("Using folder " + cacheDirectory + " as cache for IRI
/// converter.");
//
// uriDereferencer = new URIDereferencer(new File(cacheDirectory));
// }
//
// public DefaultIRIConverterGerman(Model model) {
// this(new QueryExecutionFactoryModel(model));
// }
//
// public DefaultIRIConverterGerman(OWLOntology ontology) {
...
// }
//
// // 3. try to dereference the IRI and search for the label in the returned
/// triples
...
// if(uri.equals(XSD.nonNegativeInteger.getURI()) ||
/// uri.equals(XSD.integer.getURI())
// || uri.equals(XSD.negativeInteger.getURI()) ||
/// uri.equals(XSD.decimal.getURI())
...
/// code + " - " + HttpSC.getCode(code).getMessage());
// }
// }
// return null;
// }
...
// for (String labelProperty : labelProperties) {
// for(Statement st : model.listStatements(model.getResource(iri),
/// model.getProperty(labelProperty), (RDFNode)null).toList()){
...
// String s1 = split[i];
// if(i > 0 && s1.length() == 1 &&
/// !org.apache.commons.lang3.StringUtils.isNumeric(s1)) { // single character
...
// DefaultIRIConverterGerman converter = new
/// DefaultIRIConverterGerman(SparqlEndpoint.getEndpointDBpedia());
//
// String label =
