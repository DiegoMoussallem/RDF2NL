...
// */
// public class LiteralConverterGerman {
//
// private static final Locale ENGLISH_LOCAL = Locale.UK;
// private static final Logger logger =
/// LoggerFactory.getLogger(LiteralConverterGerman.class);
...
//
// public LiteralConverterGerman(IRIConverter iriConverter) {
...
// if (dt == null || dt instanceof RDFLangString) {// plain literal, i.e. omit
/// language tag if exists
...
// String datatype = Joiner.on("
/// ").join(Arrays.asList(split).stream().filter(str ->
/// !str.trim().isEmpty()).collect(Collectors.toList()));
...
// logger.error("Conversion of date literal " + lit + " failed. Reason: " +
/// e.getMessage());
// //fallback
...
// try {
// time =
/// ISODateTimeFormat.dateTimeParser().parseDateTime(lit.getLexicalForm());
// s = time.toString("MMMM dd, yyyy");
// } catch (Exception e1) {
// try {
// time =
/// ISODateTimeFormat.localDateParser().parseDateTime(lit.getLexicalForm());
// s = time.toString("MMMM dd, yyyy");
// } catch (Exception e2) {
// e2.printStackTrace();
...
// }
// }
// boolean isPlural = (lit.getDatatypeURI() != null) && !(lit.getDatatype()
/// instanceof RDFLangString) && !(lit.getDatatype() instanceof XSDDatatype) &&
/// !singular;
// return isPlural;
// }
//
...
// LiteralConverterGerman conv = new LiteralConverterGerman(new
/// DefaultIRIConverter(
...
//
// lit = NodeFactory.createLiteral("1869-06-27", null,
/// XSDDatatype.XSDdate).getLiteral();
// System.out.println(lit + " --> " + conv.convert(lit));
//
// lit = NodeFactory.createLiteral("1914-01-01T00:00:00+02:00", null,
/// XSDDatatype.XSDgYear).getLiteral();
// System.out.println(lit + " --> " + conv.convert(lit));
//
// lit = NodeFactory.createLiteral("--04", null,
/// XSDDatatype.XSDgMonth).getLiteral();
// System.out.println(lit + " --> " + conv.convert(lit));
//
// }
// }
